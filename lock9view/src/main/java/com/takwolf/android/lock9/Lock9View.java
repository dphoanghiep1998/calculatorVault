...
//        }
    ...
    public void setEnableVibrate(boolean status) {
        Log.d("TAG", "setEnableVibrate: " + status);
        enableVibrate = status;
        invalidate();
    }

    public void setHighlighted(boolean status) {
        isVisiblePattern = status;
        invalidate();
    }
        ...
        void setHighLighted(boolean highLighted, boolean isMid) {
            if (this.highLighted != highLighted) {
                ...
                if (nodeOnSrc != null) { // 没有设置高亮图片则不变化
                    ...
                    setBackgroundDrawable(isVisiblePattern ? nodeOnSrc : nodeSrc);
                }
